python -m topobench \
    ...
    model.feature_encoder.out_channels=4,8 \
    ...
    optimizer.parameters.weight_decay=0.001,0.0001 \
    dataset.split_params.data_seed=0 \
    trainer.max_epochs=1000 \
    trainer.min_epochs=200 \
    trainer.check_val_every_n_epoch=1 \
    trainer.devices=\[0\] \
    logger.wandb.project=Proteo_new_variable_stratified_filtered_gatv4_gat \
